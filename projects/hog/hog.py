...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    assert player_score >= 0 and opponent_score >= 0, 'score must be a positive integer.'
    result = False
    if opponent_score >= 10 and player_score >= 10:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        while who == 0 and flag:
            gain_score = take_turn(strategy0(score0, score1), score1, dice=dice)
            score0 += gain_score
            ...
            if score0 >= goal:
                flag = False
        while who == 1 and flag:
            gain_score = take_turn(strategy1(score1, score0), score0, dice=dice)
            score1 += gain_score
            say = say(score0, score1)
    ...
    def say(score0, score1):
        if who == 1:
            ...
            if increase > running_high:
                print(str(increase) + ' point(s)! The most yet for Player ' + str(who))
            else:
                increase = running_high
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in range(1, 11):
        ...
        li.append(averaged(i, dice))
    maxscore = max(li)
    return li.index(maxscore)
    # END PROBLEM 9
